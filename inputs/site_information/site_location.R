...
ggmap(MapImage) +
  ...
  annotate('text', x=-116.75, y=33.85, label = 'Subalpine', color = "black", size = 8) +
  annotate('text', x=-116.77, y=33.68, label = 'Pine-Oak', color = "black", size = 8) +
  annotate('text', x=-116.45, y=33.58, label = 'Scrubland', color = "black", size = 8) +
  annotate('text', x=-116.38, y=33.70, label = 'Desert', color = "black", size = 8)
